        ...
        uglify: {
            ...
            iconset: {                
                files: {
                    ...
                    'bootstrap-iconpicker/js/iconset/iconset-gleam-4.5.0.min.js':           ['bootstrap-iconpicker/js/iconset/iconset-gleam-4.5.0.js'],
        ...
        concat: {
            ...
            iconset: {
                src: [
                    ...
                    'bootstrap-iconpicker/js/iconset/iconset-gleam-4.5.0.min.js',
